    ...
    .action(function(args, callback) {
      ...
      if (!args.seed) {
        ...
        if (args.seed.length < 30) {
          vorpal.log(chalk.red('Caution, your seed is very short.  This makes it vulnerable to guessing.  You should REALLY consider moving your cornodes to a stronger seed.\n'));
        }
