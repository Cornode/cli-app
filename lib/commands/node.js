...
const setupNodeCommand = (data, cornodejs, refreshAccountData, refreshServerInfo, vorpal) => {
  vorpal
    .command('node <address>', 'connects to a new cornode node. (ex. 1.2.3.4)')
    .autocomplete({
    ...
    .action((args, callback) => {
      ...
      cornodejs.changeNode({host, port});
